...
require_contains "$LATEST" 'scripts/restart-dexter-ui.sh' "diagnostic report missing launcher lifecycle command"
require_contains "$LATEST" 'DEXTER_STARTED_FROM' "diagnostic report missing launcher app-path handoff"
