...
assert_contains "$LAUNCHER" "scripts/restart-dexter-ui.sh" "installed launcher uses centralized lifecycle script"
assert_contains "$LAUNCHER" "DEXTER_STARTED_FROM" "installed launcher passes app path to lifecycle script"
